...
int execution_fun(char *content, stack_t **head, unsigned int counter, FILE *file);
...
void nope_func(stack_t **head, unsigned int counter);
...
void print_string_func(stack_t **head, unsigned int counter);
void rotate_func(stack_t **head, unsigned int counter);
